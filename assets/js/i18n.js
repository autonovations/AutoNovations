...
const translations = {
    en: {
        ...
        course8_title: "WSL Fundamentals",
        course8_desc: "Unlock the power of Linux on Windows. Learn to install, configure, and master WSL2, command line shell scripting, and local environments.",
        course9_title: "Docker & Containerization",
        course9_desc: "Master Docker containerization. Learn to compile custom images, manage multi-container workflows with Docker Compose, and orchestrate dev environments.",
        course10_title: "Python Programming",
        course10_desc: "Learn core Python programming. Master data structures, object-oriented concepts, syntax, and build automation scripts from scratch.",
        course11_title: "Industrial OT & Automotive Cybersecurity",
        course11_desc: "Master CAN Bus hacking, ECU defense, SCADA security, Modbus/TCP, ISO/SAE 21434, and SecOC for connected vehicles & IIoT.",
        course12_title: "TinyML & Edge AI",
        course12_desc: "Master INT8 quantization, PyTorch/TensorFlow pruning, TFLite Micro, TensorRT, and embedded deployment on ESP32, STM32, and Jetson Nano.",
        course13_title: "Real-Time Big Data & LLM Agents for Industry",
        course13_desc: "Master Apache Kafka, ClickHouse OLAP, PySpark Streaming, Vector DBs, Industrial RAG, and Multi-Agent Orchestration.",
        course14_title: "Hardware Hacking & Embedded Firmware RE",
        course14_desc: "Master IoT & Edge hardware auditing: firmware dumping via UART/JTAG, SPI/NAND Flash extraction, key extraction, and vulnerability analysis with Ghidra, GDB, and Bus Pirate.",
        course15_title: "Digital Twins & Autonomous Vehicle Simulation",
        course15_desc: "Master NVIDIA Isaac Sim, Omniverse, CARLA Simulator, OpenUSD, ROS 2 bridge, and synthetic LiDAR ray-tracing pipeline for autonomous vehicles.",
        course16_title: "Swarm Robotics & Autonomous Drone Fleets",
        course16_desc: "Master PX4 Autopilot, MAVLink 2.0, ROS 2 Offboard control, Reynolds Boids consensus algorithms, V-SLAM, and GPS-Denied navigation.",
        ...
        terminal_courses_desc: "Academy Courses:<br>1. Basic Trading<br>2. Algorithmic Trading<br>3. Basic Electronics<br>4. UAV Electronic Engineering<br>5. Machine Learning<br>6. Data Engineering<br>7. ROS2 Robotics<br>8. WSL Fundamentals<br>9. Docker & Containerization<br>10. Python Programming<br>11. OT & Automotive Cybersecurity<br>12. TinyML & Edge AI<br>13. Real-Time Big Data & LLM Agents",
    ...
    es: {
        ...
        course8_title: "Fundamentos de WSL",
        course8_desc: "Desbloquea el poder de Linux en Windows. Aprende a instalar, configurar y dominar WSL2, scripting en línea de comandos y entornos locales.",
        course9_title: "Docker y Contenedores",
        course9_desc: "Domina la contenedorización con Docker. Aprende a compilar imágenes personalizadas, administrar flujos de trabajo multicontenedor con Docker Compose y orquestar entornos.",
        course10_title: "Programación en Python",
        course10_desc: "Aprende programación básica en Python. Domina estructuras de datos, conceptos orientados a objetos, sintaxis y construye scripts de automatización desde cero.",
        course11_title: "Ciberseguridad OT & Automotriz",
        course11_desc: "Domina CAN Bus hacking, defensa de ECUs, seguridad en SCADA, Modbus/TCP, ISO/SAE 21434 y SecOC para vehículos conectados e IIoT.",
        course12_title: "TinyML & Edge AI",
        course12_desc: "Domina cuantización INT8, pruning en PyTorch/TensorFlow, TFLite Micro, TensorRT y despliegue embebido en ESP32, STM32 y Jetson Nano.",
        course13_title: "Real-Time Big Data & Agentes LLM para la Industria",
        course13_desc: "Domina Apache Kafka, ClickHouse OLAP, PySpark Streaming, Vector DBs, RAG Industrial y Orquestación Multi-Agente.",
        course14_title: "Hardware Hacking & Firmware Reverse Engineering",
        course14_desc: "Domina la auditoría de hardware IoT/Edge: lectura de firmware vía UART/JTAG, extracción de claves en memorias SPI/NAND Flash y análisis de vulnerabilidades con Ghidra, GDB y Bus Pirate.",
        course15_title: "Digital Twins & Simulación de Vehículos Autónomos",
        course15_desc: "Domina NVIDIA Isaac Sim, Omniverse, CARLA Simulator, OpenUSD, puentes ROS 2 y renderizado sintético de sensores LiDAR/RGB-D.",
        course16_title: "Robótica de Enjambre & Flotas de Drones Autónomos",
        course16_desc: "Domina PX4 Autopilot, MAVLink 2.0, control Offboard en ROS 2, algoritmos de consenso Boids, V-SLAM y navegación sin GPS.",
        ...
        terminal_help_desc: "Comandos disponibles:<br>- help: lista comandos<br>- about: información sobre nosotros<br>- projects: lista innovaciones<br>- courses: lista cursos de academia<br>- status: reporte de diagnóstico<br>- clear: limpiar pantalla<br>- secret: operator level authentication",
        ...
        terminal_courses_desc: "Cursos de la Academia:<br>1. Trading Básico<br>2. Trading Algorítmico<br>3. Electrónica Básica<br>4. Ingeniería Electrónica de UAV<br>5. Machine Learning<br>6. Ingeniería de Datos<br>7. Robótica ROS2<br>8. Fundamentos de WSL<br>9. Docker y Contenedores<br>10. Programación en Python<br>11. Ciberseguridad OT & Automotriz<br>12. TinyML & Edge AI<br>13. Real-Time Big Data & Agentes LLM",
