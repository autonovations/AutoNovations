...
const translations = {
    en: {
        ...
        terminal_projects_desc: "Current Projects:<br>- Railytics (Railway intelligence)<br>- Cognitive Companions (Mechatronics)<br>- AI Trading Core (Machine learning yield)<br>- AeroExplorer (Drone simulator)<br>- VSOC (Virtual Security Center)",
    ...
    es: {
        ...
        terminal_projects_desc: "Proyectos Actuales:<br>- Railytics (Inteligencia ferroviaria)<br>- Compañeros Cognitivos (Mecatrónica)<br>- Núcleo de Trading IA (Rendimiento ML)<br>- AeroExplorer (Simulador de Dron)<br>- VSOC (Centro de Seguridad Virtual)",
